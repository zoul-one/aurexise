...
from aurexise.aurexise.utils import get_party_link_if_exist, get_conversion_factor
...
@frappe.whitelist()
def get_metal_ledger_entries(party_type, party, metal_type, purity):
	...
	if party_link:
		filters = { 'party_link': party_link,  'metal_type':metal_type , 'is_cancelled': 0 }
	else:
		filters = { 'party_type': party_type, 'party':party, 'metal_type':metal_type , 'is_cancelled': 0 }
